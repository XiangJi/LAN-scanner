...
{ int i;
  ...
  {scanningip=ipbase.concat(Integer.toString(i));
   ThreadScan.status1.setText("Scanning status: scanning hosts"+scanningip);
 ...
 try{   
	   ...
	   ThreadScan.Result1.append(scanningip+":"+"Online"+"      Hostname: "+HostName+"  MAC address:"+macname+'\n');
	  // ThreadScan.Result1.append("mac"+macname+'\n');
		}
		}
		catch (IOException e)
        {continue;}
